...
# Mock medfilt to return the data as-is
sys.modules["scipy.signal"].medfilt.side_effect = lambda x, kernel_size: x
...
class TestWorker(unittest.TestCase):
    ...
    def test_predict_fg_from_curve_success(self, mock_curve_fit):
